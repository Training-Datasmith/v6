...
if (isset($_POST['filter-update']) && isset($_POST['filter']['subdir'])) {
    httpredir(currentPage(null, ['subdir' => urlencode($_POST['filter']['subdir'])]));
}
...
if (isset($_GET['fm-edit']) && is_numeric($_GET['fm-edit'])) {
    ...
    $GLOBALS['main']->addTabControl($lang['filemanager']['tab_rebuild'], false, currentPage(null, ['rebuild' => 'true']));
