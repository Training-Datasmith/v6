...
$nav_items['inventory']  = [
    $lang['navigation']['nav_categories']  => ['address' => '?_g=categories', 'id' => 'nav_categories'],
    $lang['navigation']['nav_products']   => ['address' => '?_g=products&node=index', 'id' => 'nav_products'],
...
$nav_items['filemanager'] = [
    $lang['navigation']['nav_documents']  => ['address' => '?_g=documents', 'id' => 'nav_docs'],
...
$nav_items['settings']  = [
    ...
    $lang['navigation']['nav_settings_store'] => ['address' => '?_g=settings', 'id' => 'nav_settings'],
...
$nav_items['modules']  = [
    $lang['navigation']['nav_marketplace']   => ['address' => '?_g=marketplace', 'target' => '_blank', 'id' => 'nav_marketplace', 'icon' => 'fa-external-link'],
    $lang['navigation']['nav_plugins']   => ['address' => '?_g=plugins', 'id' => 'nav_plugins'],
];
