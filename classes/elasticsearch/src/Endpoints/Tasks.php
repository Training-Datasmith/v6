 ...
 */
class Tasks extends Abstract_Endpoint
{
    /**
    ...
    public function cancel(array $params = [])
    {
        ...
        $url = $this->add_query_string($url, $params, ['nodes', 'actions', 'parent_task_id', 'wait_for_completion', 'pretty', 'human', 'error_trace', 'source', 'filter_path']);
    ...
    {
        $this->check_required_parameters(['task_id'], $params);
    ...
    public function list(array $params = [])
    {
        $url = '/_tasks';
        $method = 'GET';
        $url = $this->add_query_string($url, $params, ['nodes', 'actions', 'detailed', 'parent_task_id', 'wait_for_completion', 'group_by', 'timeout', 'pretty', 'human', 'error_trace', 'source', 'filter_path']);
        $headers = ['Accept' => 'application/json'];
        return $this->client->send_request($this->create_request($method, $url, $headers, $params['body'] ?? null));
    }
}