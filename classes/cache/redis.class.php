...
class Cache extends Cache_Controler
{
    ...
    public function clear($type = '')
    {
        ...
        if (!empty($this->_ids)) {
            ...
            foreach ($this->_ids as $id) {
                if (!(bool) $this->_redis->del($this->_make_name($id))) {
                    $return = false;
                }
            }
    ...
    public function delete($id): bool
    {
        ...
        return (bool) $this->_redis->del($this->_make_name($id));
    }
    /**
    ...
    public function exists($id)
    {
        ...
        $id = short_hash($id, 8, [$this->_empties_id]);
        return (bool) $this->_redis->exists($this->_make_name($id));
    }
    /**
    ...
    public function usage(): string
    {
        ...
        $output .= '<tr><td>Total keys</td><td>' . $this->_redis->db_size() . '</td></tr>';
