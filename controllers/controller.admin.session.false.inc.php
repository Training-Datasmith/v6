...
switch (strtolower($_GET['_g'])) {
    case 'twofa':
        ...
        $pending_admin = $GLOBALS['db']->select(
            'CubeCart_admin_users',
            ['twofa_method', 'twofa_otp_expires', 'email'],
            ['admin_id' => $pending_id, 'status' => 1],
            false,
            1,
            false,
            false
        ...
        $GLOBALS['smarty']->assign('TWOFA', [
            'method'     => $pa['twofa_method'],
            'can_resend' => $can_resend,
            'email_hint' => $email_hint,
            'resend_url' => currentPage(null, ['resend' => '1']),
        ]);
        break;
    case 'recovery':
