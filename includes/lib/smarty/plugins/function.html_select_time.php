...
{
    $template->_check_plugins([['function' => 'smarty_function_escape_special_chars', 'file' => SMARTY_PLUGINS_DIR . 'shared.escape_special_chars.php']]);
    $prefix = 'Time_';
    $field_array = null;
    $field_separator = "\n";
    $option_separator = "\n";
        ...
        switch ($_key) {
            case 'time':
                if (!is_array($_value) && $_value !== null) {
                    $template->_check_plugins([['function' => 'smarty_make_timestamp', 'file' => SMARTY_PLUGINS_DIR . 'shared.make_timestamp.php']]);
    ...
    if (isset($params['time']) && is_array($params['time'])) {
        if (isset($params['time'][$prefix . 'Hour'])) {
            ...
            foreach (['H' => 'Hour', 'i' => 'Minute', 's' => 'Second'] as $_element_key => $_element_name) {
                ...
                ${$_variable_name} = isset($params['time'][$prefix . $_element_name]) ? $params['time'][$prefix . $_element_name] : date($_element_key);
            }
            ...
            foreach (['H' => 'Hour', 'i' => 'Minute', 's' => 'Second'] as $_element_key => $_element_name) {
                $_variable_name = '_' . strtolower($_element_name);
                ${$_variable_name} = isset($params['time'][$field_array][$prefix . $_element_name]) ? $params['time'][$field_array][$prefix . $_element_name] : date($_element_key);
            }
