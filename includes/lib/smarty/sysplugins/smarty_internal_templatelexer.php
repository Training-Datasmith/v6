...
class Smarty_Internal_Templatelexer
{
     ...
     */
    public function __construct($source, Smarty_internal_template_Compiler_Base $compiler)
    {
        $this->data = $source;
    ...
    public function yypushstate($state)
    {
        if ($this->yy_trace_file) {
            fprintf($this->yy_trace_file, "%sState push %s\n", $this->yy_trace_prompt, isset($this->state_name[$this->_yy_state]) ? $this->state_name[$this->_yy_state] : $this->_yy_state);
        }
