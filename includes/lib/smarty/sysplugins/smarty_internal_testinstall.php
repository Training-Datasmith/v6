 ...
 * @subpackage Utilities
 */
class Smarty_internal_test_Install
{
    /**
    ...
    public static function test_install(Smarty $smarty, &$errors = null)
    {
            ...
            if (!$template_dir) {
                if ($smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $_template_dir)) {
                    ...
                    if ($_stream_resolve_include_path) {
                        ...
                        $template_dir = $smarty->ext->_get_include_path->get_include_path($_template_dir, null, $smarty);
                    }
        ...
        foreach ($smarty->get_plugins_dir() as $plugin_dir) {
            ...
            if (!$plugin_dir) {
                if ($smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $_plugin_dir)) {
                    ...
                    if ($_stream_resolve_include_path) {
                        ...
                        $plugin_dir = $smarty->ext->_get_include_path->get_include_path($_plugin_dir, null, $smarty);
                    }
                    if ($plugin_dir !== false) {
                        if ($errors === null) {
            ...
            if (!$config_dir) {
                if ($smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $_config_dir)) {
                    ...
                    if ($_stream_resolve_include_path) {
                        ...
                        $config_dir = $smarty->ext->_get_include_path->get_include_path($_config_dir, null, $smarty);
                    }
                    if ($config_dir !== false) {
                        if ($errors === null) {
