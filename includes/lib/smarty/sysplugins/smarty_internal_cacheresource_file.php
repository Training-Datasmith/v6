 ...
 * @subpackage Cacher
 */
class Smarty_internal_cache_Resource_file extends Smarty_cache_Resource
{
    /**
    ...
    {
        if ($_template->smarty->ext->_write_file->write_file($_template->cached->filepath, $content, $_template->smarty) === true) {
    ...
    {
        return $smarty->ext->_cache_resource_file->clear($smarty, null, null, null, $exp_time);
    }
    /**
    ...
    {
        return $smarty->ext->_cache_resource_file->clear($smarty, $resource_name, $cache_id, $compile_id, $exp_time);
    }
    /**
