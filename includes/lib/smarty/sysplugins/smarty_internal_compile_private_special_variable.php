 ...
 * @subpackage Compiler
 */
class Smarty_Internal_Compile_Private_Special_Variable extends Smarty_internal_compile_Base
{
    /**
    ...
    public function compile($args, Smarty_internal_template_Compiler_Base $compiler, $parameter)
    {
        ...
        if (!isset($compiler->smarty->security_policy) || $compiler->smarty->security_policy->is_trusted_special_smarty_var($variable, $compiler)) {
            switch ($variable) {
                case 'foreach':
                case 'section':
                    if (!isset(Smarty_internal_template_Compiler_Base::$_tag_objects[$variable])) {
                        $class = 'Smarty_Internal_Compile_' . smarty_ucfirst_ascii($variable);
                        Smarty_internal_template_Compiler_Base::$_tag_objects[$variable] = new $class();
                    }
                    return Smarty_internal_template_Compiler_Base::$_tag_objects[$variable]->compile_special_variable([], $compiler, $_index);
                case 'capture':
                    if (class_exists('Smarty_Internal_Compile_Capture')) {
                        return Smarty_Internal_Compile_Capture::compile_special_variable([], $compiler, $_index);
                    }
                    return '';
                case 'now':
                    return 'time()';
