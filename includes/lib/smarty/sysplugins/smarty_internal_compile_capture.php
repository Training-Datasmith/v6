 ...
 * @subpackage Compiler
 */
class Smarty_Internal_Compile_Capture extends Smarty_internal_compile_Base
{
    /**
     ...
     */
    public static function compile_special_variable($args, Smarty_internal_template_Compiler_Base $compiler, $parameter = null)
    {
     ...
     * @return string compiled code
     */
    public function compile($args, Smarty_internal_template_Compiler_Base $compiler, $parameter = null)
    {
        // check and get attributes
        $_attr = $this->get_attributes($compiler, $args, $parameter, 'capture');
 ...
 * @subpackage Compiler
 */
class Smarty_internal_compile_capture_Close extends Smarty_internal_compile_Base
{
    /**
     * Compiles code for the {/capture} tag
     *
