 ...
 * @subpackage Compiler
 */
class Smarty_Internal_Compile_Private_Registered_Function extends Smarty_internal_compile_Base
{
    /**
     ...
     */
    public function compile($args, Smarty_internal_template_Compiler_Base $compiler, $parameter, $tag)
    {
        ...
        foreach ($_attr as $_key => $_value) {
            if (is_int($_key)) {
                ...
                $_params_array[] = "'{$_key}'=>^#^.var_export({$_value},true).^#^";
            } else {
                $_params_array[] = "'{$_key}'=>{$_value}";
            }
        }
