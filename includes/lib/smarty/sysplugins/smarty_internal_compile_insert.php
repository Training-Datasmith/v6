 ...
 * @subpackage Compiler
 */
class Smarty_Internal_Compile_Insert extends Smarty_internal_compile_Base
{
    /**
    ...
    public function compile($args, Smarty_internal_template_Compiler_Base $compiler)
    {
        ...
        $nocache_param = $compiler->template->caching && ($compiler->tag_nocache || $compiler->nocache);
        if (!$nocache_param) {
        ...
        if (isset($_attr['script'])) {
            ...
            if (!is_callable($_function)) {
                // try plugin
                if (!$_function = $compiler->get_plugin($_name, 'insert')) {
        ...
        // call insert
        if (isset($_assign)) {
            if ($_smarty_tpl->caching && !$nocache_param) {
                $_output .= "echo Smarty_Internal_Nocache_Insert::compile ('{$_function}',{$_params}, \$_smarty_tpl, '{$_filepath}',{$_assign});?>";
            } else {
                $_output .= "\$_smarty_tpl->assign({$_assign} , {$_function} ({$_params},\$_smarty_tpl), true);?>";
            }
        } else if ($_smarty_tpl->caching && !$nocache_param) {
